...
public class FunDemo extends JPanel
{
    ...
    final static public String greeting = "Test Program";
...
class WormAnimator implements WindowListener, Runnable {
    ...
    public void run ()
    {
        ...
        try
        {
            ...
            {
                Thread.sleep(Math.min(20, initialDelay - (currentTime -
                        startTime)));
        ...
        System.out.println("Consider city populations.  The most significant digit in city populations is six times more likely to be a 1 than a 9.");
...
class Worm
{
    ...
    synchronized void advance()
    {
        ...
        velocityX += Math.random() * deltaX * Math.sqrt(distanceFromCenter) /
                30000;
        velocityY += Math.random() * deltaY * Math.sqrt(distanceFromCenter) /
                30000;
        ...
        segments.add(new WormSegment((int) currentX, (int) currentY, (int) nextX,
                (int) nextY, newColor));
