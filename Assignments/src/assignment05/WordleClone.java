...
//		int wordNumber = (int) (Math.random() * countWords(filename)) + 1;
//		String currWord = "";
//		/* TODO: Complete this function */
//		for (int i = 1; i <= wordNumber; i++)
//		{
//			currWord = String.valueOf(fileContents.hasNext());
//			if (i == wordNumber)
//			{
//				break;
//			}
...
//	 */
//	public static boolean isValidWord (String word, String filename) throws FileNotFoundException {
//		/* TODO: Complete this function */
//		File file = new File(filename);
//		Scanner fileContents = new Scanner(file);
...
//		{
//			if (word.equals(fileContents.hasNext()))
//			{
//				validStatus = true;
//			}
//		}
